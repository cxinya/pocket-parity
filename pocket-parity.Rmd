...
output: 
  html_document:
    toc: true
    toc_float: true
    css: ["pocket-parity-style.css", "www/css/zilla-slab.css", "www/css/montserrat.css"]
---
